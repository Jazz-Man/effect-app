...
export interface HttpClient
  extends HttpClient.With<HttpClientError.HttpClientError> {}
...
export const tag = Context.GenericTag<HttpClient>("@effect-app/BunHttpClient");

/**
 * @since 1.0.0
 * @category tags
 */
export const HttpClient: Context.Tag<HttpClient, HttpClient> = tag;
...
export const filterStatus: {
  (
    ...
    self: HttpClient.With<E, R>,
  ) => HttpClient.With<E | HttpClientError.ResponseError, R>;
  <E, R>(
    self: HttpClient.With<E, R>,
    f: (status: number) => boolean,
  ): HttpClient.With<E | HttpClientError.ResponseError, R>;
