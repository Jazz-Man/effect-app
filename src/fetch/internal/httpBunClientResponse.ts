...
/** @internal */
export const TypeId: HttpClientResponse.TypeId = Symbol.for(
  "@effect/platform/HttpClientResponse",
) as HttpClientResponse.TypeId;
...
export const fromWeb = (
  ...
  new ClientResponseImpl(request, source);
  ...
  implements HttpClientResponse.HttpClientResponse
{
  ...
  readonly [TypeId]: HttpClientResponse.TypeId;
  ...
  private textBody?: Effect.Effect<string, HttpClientError.ResponseError>;
  ...
  private formDataBody?: Effect.Effect<FormData, HttpClientError.ResponseError>;
  ...
  <
    const Cases extends {
      readonly [status: number]: (
        _: HttpClientResponse.HttpClientResponse,
      ) => any;
      readonly "2xx"?: (_: HttpClientResponse.HttpClientResponse) => any;
      readonly "3xx"?: (_: HttpClientResponse.HttpClientResponse) => any;
      readonly "4xx"?: (_: HttpClientResponse.HttpClientResponse) => any;
      readonly "5xx"?: (_: HttpClientResponse.HttpClientResponse) => any;
      readonly orElse: (_: HttpClientResponse.HttpClientResponse) => any;
    },
  >(
    cases: Cases,
  ) => (
