...
import { layerMergedContext, make } from "./httpBunClient.ts";
...
export const fetch: BunHttpClient = make((request, url, signal, fiber) => {
...
/** @internal */
export const layer = layerMergedContext(Effect.succeed(fetch));
